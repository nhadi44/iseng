<section id="facts" class="video-counter pt-90">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="counter-wrapper mt-50 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                    <div class="counter-content">
                        <div class="section-title">
                            <div class="line"></div>
                            <h3 class="title">TENTANG KAMI <br>ORMAWA STT Bandung</span></h3>
                        </div> <!-- section title -->
                        <p class="text">Terdapat 18 Organisasi Mahasiswa Sekolah Tinggi Teknologi Bandung </p>
                    </div> <!-- counter content -->
                        ...
                        <div class="col-4">
                            <div
                                ...
                                <div class="counter-items text-center">
                                    <span class="count"><span class="counter">1</span></span>
                                    <p class="text">DPM</p>
                                </div>
                            </div> <!-- single counter -->
                        </div>
                        ...
                        <div class="col-4">
                            <div
                                ...
                                <div class="counter-items text-center">
                                    ...
                                    <p class="text">Himpunan</p>
                                </div>
                            </div> <!-- single counter -->
                        </div>
                        <div class="col-4 mx-5 md-2">
                            <div
                                class="single-counter counter-color-2 d-flex align-items-center justify-content-center">
                                <div class="counter-items text-center">
